            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form>
                  ...
                  <RouterLink to="/admin/" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sign Up</RouterLink>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Already have an Account?</p>
                    <RouterLink class="text-primary fw-bold ms-2" to="/admin/signi">Sign In</RouterLink>
                  </div>
                </form>
              </div>
            </div>
